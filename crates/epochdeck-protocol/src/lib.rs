...
mod tests {
    ...
    use super::{
        AlertLevel, ChartAlignment, DashboardConfigResponse, HealthResponse, HealthStatus,
        IngestBatchRequest, ProjectId, ResumePolicy, RunId, RunState,
    };
    ...
    fn healthy_response_is_stable() {
        ...
        assert_eq!(response.service, "epochdeck");
        assert_eq!(response.status, HealthStatus::Healthy);
    }

    #[test]
    fn dashboard_config_response_is_stable() -> Result<(), serde_json::Error> {
