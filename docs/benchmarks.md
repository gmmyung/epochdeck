...
Temporary data is removed after each run.

Reference smoke result on an Apple M5 Pro on 2026-08-28:

```text
rows=200000 metrics=180 segments_before=196 segments_after=13
compaction_seconds=2.935 compacted_mib=97.52
write_seconds=13.631 stored_mib=114.78
sampled_query_seconds=0.029 source_points=200000 returned_points=5000
```
